...
# Generated by qmake (2.01a) (Qt 4.8.6) on: Mon May 18 13:49:12 2015
# Project:  WVS.pro
# Template: app
...
INCPATH       = -I/usr/share/qt4/mkspecs/linux-g++-64 -I. -I/usr/include/qt4/QtCore -I/usr/include/qt4/QtGui -I/usr/include/qt4/QtOpenGL -I/usr/include/qt4/QtSvg -I/usr/include/qt4 -I/usr/X11R6/include -I. -I.
LINK          = g++
LFLAGS        = -m64 -Wl,-O1
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -L/usr/X11R6/lib64 -lQtSvg -lQtOpenGL -lQtGui -lQtCore -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
...
SOURCES       = main.cpp \
		...
		GLContainer.cpp \
		stdafx.cpp \
		SvgPainter.cpp moc_wvs_main_window.cpp \
		moc_GLContainer.cpp \
		moc_GLWidget.cpp \
		moc_SvgPainter.cpp
OBJECTS       = main.o \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/WVS1.0.0/ && $(COPY_FILE) --parents wvs_main_window.h GLContainer.h MyPoint.h stdafx.h GLWidget.h SvgPainter.h .tmp/WVS1.0.0/ && $(COPY_FILE) --parents main.cpp wvs_main_window.cpp GLWidget.cpp GLContainer.cpp stdafx.cpp SvgPainter.cpp .tmp/WVS1.0.0/ && $(COPY_FILE) --parents wvs_main_window.ui .tmp/WVS1.0.0/ && (cd `dirname .tmp/WVS1.0.0` && $(TAR) WVS1.0.0.tar WVS1.0.0 && $(COMPRESS) WVS1.0.0.tar) && $(MOVE) `dirname .tmp/WVS1.0.0`/WVS1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/WVS1.0.0
...
compiler_moc_header_make_all: moc_wvs_main_window.cpp moc_GLContainer.cpp moc_GLWidget.cpp moc_SvgPainter.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_wvs_main_window.cpp moc_GLContainer.cpp moc_GLWidget.cpp moc_SvgPainter.cpp
...
moc_SvgPainter.cpp: stdafx.h \
		MyPoint.h \
		SvgPainter.h
	/usr/lib/x86_64-linux-gnu/qt4/bin/moc $(DEFINES) $(INCPATH) SvgPainter.h -o moc_SvgPainter.cpp
...
SvgPainter.o: SvgPainter.cpp stdafx.h \
		SvgPainter.h \
		MyPoint.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o SvgPainter.o SvgPainter.cpp
...
moc_SvgPainter.o: moc_SvgPainter.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_SvgPainter.o moc_SvgPainter.cpp
